...
const ProjectCards = ({ project }) => {
  ...
  return (
    <Link to={`project/${id}`}>
      <div className="dark:bg-gray-800p-4 container mx-auto max-w-lg rounded-3xl bg-white transition-all duration-100 ease-in-out hover:shadow-2xl dark:border-gray-700 lg:px-10 lg:py-6 ">
